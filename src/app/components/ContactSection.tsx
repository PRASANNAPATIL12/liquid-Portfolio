...
const ContactSection: FC = () => {
  return (
    <section id="contact" className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <Card className="max-w-xl mx-auto bg-card/80 backdrop-blur-sm border-primary/50 shadow-neon-primary p-2 sm:p-4">
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center space-x-3 p-3 rounded-md hover:bg-primary/10 transition-colors">
